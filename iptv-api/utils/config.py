...
class ConfigManager:
    ...
    @property
    def open_jmtv_client_direct_mode(self):
        return self.config.getboolean("Settings", "open_jmtv_client_direct_mode", fallback=False)

    @property
    def jmtv_client_urls_limit(self):
        return self.config.getint("Settings", "jmtv_client_urls_limit", fallback=20)
