...
open_jmtv_client_direct_mode = config.open_jmtv_client_direct_mode
...
def get_sort_result(
    ...
    for result in results:
        ...
        if result_delay == -1 and not open_jmtv_client_direct_mode:
            continue
        if not supply and not open_jmtv_client_direct_mode:
